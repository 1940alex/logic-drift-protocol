...
\subsection{The truth-tracking objection}
...
This also separates the truth-tracking objection from genuine methodological limitations: a single stimulus pair, decoding-parameter effects, parsing transparency, and prompt-version robustness. Those limitations could weaken or overturn the result, and we discuss them in \S\ref{sec:limitations}. The present claim is only that the observed model-level heterogeneity is informative enough to warrant further controlled work.
